...
const CardCategory = ({ cardCategory }) => {
  ...
  return (
    <Link
      ...
      className="w-240 h-[9.4vw] block overflow-hidden border-[3.5px] border-solid rounded-[10px] border-[#3a3c4a] shadow-[#000000b0_0_26px_30px_-10px,#000000b0_0_16px_10px_-10px] relative"
    >
      <div
